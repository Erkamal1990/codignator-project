            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panelss">
                ...
                <div class="x_content">
                  <br />
                  <?php
                  echo form_open_multipart('admin/setting/add',array('method'=>'post','class'=>'form-horizontal form-label-left validate_form'))?>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        <input type="text" id="name" name="name" class="form-control validate[required]" placeholder="Setting Name*">
                    </div>
                    <div class="form-group">
                        <input type="text" id="value" name="value" class="form-control validate[required]" placeholder="Setting Value*">
                    </div>
                    <div class="form-group">
