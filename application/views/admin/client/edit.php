            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panelss">
                ...
                <div class="x_content">
                  <br />
                  <?php
                  echo form_open_multipart('admin/client/edit/'.$data['img_id'],array('method'=>'post','class'=>'form-horizontal form-label-left validate_form'))?>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        <input type="text" id="name" name="name" class="form-control validate[required]" placeholder="Client Name*" value="<?php echo $data['name'];?>">
                    </div>
                    <div class="form-group">
                      <label for="client_img" class="btn btn-info">Image</label>
                        ...
                        <img id="product" height="50px" src="<?php echo base_url().'uploads/client/'.$data['image_url'];?>" alt="" />
                    </div>
                     <div class="form-group">
