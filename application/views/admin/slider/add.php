            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panelss">
                ...
                <div class="x_content">
                  <br />
                  <?php
                  echo form_open_multipart('admin/slider/add',array('method'=>'post','class'=>'form-horizontal form-label-left validate_form'))?>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="form-group">
                        <input type="text" id="url" name="url" class="form-control validate[required]" placeholder="Link*">
                    </div>
                  </div>
                  <div class="col-lg-12 nopadding">
                    <textarea id="txtEditor" placeholder="Banner text" name="description"></textarea>
                  </div>
                  <div class="clearfix"></div>
